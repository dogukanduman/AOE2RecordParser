...
class TestFastUserPatch15(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        with open('/Users/dogukanduman/Downloads/aoc-mgz-master/tests/recs/small.mgz', 'rb') as handle:
...
class TestFastDE(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        with open('/tests/test/de-13.34.aoe2record', 'rb') as handle:
            cls.data = parse(handle)
...
class TestFastHD(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        with open('/Users/dogukanduman/Downloads/aoc-mgz-master/tests/recs/hd-5.8.aoe2record', 'rb') as handle:
            cls.data = parse(handle)
